  ...
  return (
    <section className="py-20 bg-lightGray">
      <div className="container mx-auto px-4">
        ...
        <p className="text-gray-700">Mission: At AURORAWAVE LABS, our mission is to pioneer the future of software solutions by integrating cutting-edge technologies.</p>
      </div>
    </section>
  );
};
